...
public class DistributedSimulationLauncher {
	...
	public static void run(List<String> linksToDisable) throws AnnotationProcessorException {
	...
	private static void createAndDeployVehicleComponent(int idx,
		...
		RuntimeFramework runtime = builder.build(host, simulation, null, model,
				new AlwaysRebroadcastingKnowledgeDataManager(model.getEnsembleDefinitions(), null), new CloningKnowledgeManagerFactory());
		runtime.start();
	}
