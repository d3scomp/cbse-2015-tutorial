...
public class Settings {
	...
	// Train parameters
	public static final double TRAIN_FORM_DISTANCE = 200; // m
	public static final double TRAIN_MAX_CAR_DIST = 200; // m
	public static final double TRAIN_MIN_CAR_DIST = 50; // m
